...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            if (button == "register")
            {
                return Redirect("/Account/Register?ReturnUrl=" + HttpUtility.UrlEncode(model.ReturnUrl));
            }
        ...
        {
            return View(new RegisterViewModel(){ReturnUrl = returnUrl, Departments = _identityContext.Departments.ToList()});
        }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string button)
        {
            ...
            return Redirect("/Account/Login?ReturnUrl=" + HttpUtility.UrlEncode(model.ReturnUrl));
        }
